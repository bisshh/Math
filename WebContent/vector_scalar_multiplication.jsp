...
<title>Scalar multiplication of given vectors - Math Assignment</title>
		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <p class="navbar-brand">Program to calculate scalar multiplication of given vectors</p>
                </div>
            </div>
        </nav>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-8 col-md-7">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Calculate the scalar multiplication of given vectors</h4>
                            </div>
                            <div class="content">
                                <form class="form-horizontal" method="post">
									...
									<div class="alert alert-info alert-with-icon" style="padding-left:15px;" data-notify="container">
                                        <span data-notify="message">
											...
											<%
												out.println("Scalar multiplication of given vectors =" + dotProduct);
											%>
										</span>
                                    </div>
                                </form>
