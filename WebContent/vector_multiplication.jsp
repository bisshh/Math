...
<title>Multiplication of two vectors in x,y,z coordinates - Math Assignment</title>
		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <p class="navbar-brand">Program to calculate Multiplication of two vectors in x, y, z coordinates</p>
                </div>
            </div>
        </nav>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-8 col-md-7">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Calculate the multiplication of two vectors in x, y, z coordinates</h4>
                            </div>
                            <div class="content">
                                <form class="form-horizontal" method="post">
									...
									<div class="alert alert-info alert-with-icon" style="padding-left:15px;" data-notify="container">
                                        <span data-notify="message">
											...
											<%
												out.println("Multiplication of two vectors = (" + vectorX + ") , (" + vectorY + ") , (" + vectorZ + ")");
											%>
										</span>
                                    </div>
                                </form>
