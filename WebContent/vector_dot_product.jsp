...
<title>Dot product of two vectors - Math Assignment</title>
...
double ai, aj, ak, bi, bj, bk, dotProduct;
dotProduct = 0;
		...
		<nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <p class="navbar-brand">Program to calculate dot product of two vectors</p>
                </div>
            </div>
        </nav>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-8 col-md-7">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Calculate the dot product of two vectors</h4>
                            </div>
                            <div class="content">
                                <form class="form-horizontal" method="post">
									...
									<div class="alert alert-info alert-with-icon" style="padding-left:15px;" data-notify="container">
                                        <span data-notify="message">
											...
											<%
												out.println("Dot Product of two vector = " + dotProduct);
											%>
										</span>
                                    </div>
                                </form>
